...
@interface Homepagefour ()<UITableViewDataSource,UITableViewDelegate>
{
    int _page;
}
...
-(void)getdata:(int)page
{
    ...
    NSString * url =[NSString stringWithFormat:IWATCH_FIRST_REPORT,_page];
